...
#ifndef RHECOMPONENTINFO_H
#define RHECOMPONENTINFO_H
...
class RHECOMPONENT_EXPORT RHEComponentInfo : public AbstractModelComponentInfo
{
    Q_OBJECT
...
Q_DECLARE_METATYPE(RHEComponentInfo*)

#endif // RHECOMPONENTINFO_H
